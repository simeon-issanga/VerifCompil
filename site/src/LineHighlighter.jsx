...
export const lineHighlighter = ViewPlugin.fromClass(class {
    ...
    build(view) {
        ...
        for (const { from, to } of view.visibleRanges) {
            ...
            while (pos <= to) {
                ...
                const deco = line.number % 2 === 0 ? evenLine : oddLine //TODO décider la couleur des lignes et ajouter le onOver
